...
<body>
    ...
    $query = "SELECT ROUND(celsius, 1) AS celsius FROM temperatur3 ORDER BY id desc";
    $result = mysqli_query($con, $query);
    ...
    $query = "SELECT ROUND(max(celsius), 1) AS max_temp, ROUND(min(celsius), 1) AS min_temp FROM temperatur3";
    $result = mysqli_query($con, $query);
